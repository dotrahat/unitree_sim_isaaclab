...
"""Convert g1_23dof_mode_10_with_brainco.urdf to USD format."""

import argparse

from isaaclab.app import AppLauncher

parser = argparse.ArgumentParser(description="Convert g1_23dof_mode_10_with_brainco URDF to USD")
...
def main():
    ...
    dest_path = os.path.join(
        os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
        "assets/robots/g1-23dof-brainco-base-fix-usd/with_wrist_cams/g1_23dof_mode_10_with_brainco_wrist_cams.usd",
    )
