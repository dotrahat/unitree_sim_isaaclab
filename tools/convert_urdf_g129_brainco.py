...
"""Convert g1_29dof_with_brainco.urdf to USD format."""

import argparse

from isaaclab.app import AppLauncher

parser = argparse.ArgumentParser(description="Convert g1_29dof_with_brainco URDF to USD")
...
def main():
    urdf_path = os.path.join(
        ...
        "assets/robots/g1-29dof-brainco-base-fix-usd/URDFs/g1_29dof_mode_15_brainco_hand.urdf",
    )
    ...
    dest_path = os.path.join(
        os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
        "assets/robots/g1-29dof-brainco-base-fix-usd/g1_29dof_with_brainco.usd",
    )
